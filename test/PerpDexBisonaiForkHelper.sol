...
contract PerpDex is Initializable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable, ReentrancyGuardUpgradeable {
    ...
    IERC20 d_usdt; // deprecated
    ILP d_lp; // deprecated
    IFee d_feeContract; // deprecated
    ...
    address[] d_liquidationAdmins; // deprecated
    address[] d_limitOrderAdmins; // deprecated

    mapping(uint256 => PerpDexLib.Position) positions;
    mapping(address => uint256[]) traderPositionIds;
    uint256[] openPositionIds;
    uint256[] d_requestedOpenPositionIds; // deprecated
    ...
    address[] d_singleOpenAdmins; // deprecated
    address[] d_closeAdmins; // deprecated
    address d_multiOpenAdmin; // deprecated

    mapping(address => mapping(uint16 => PerpDexLib.TraderOpenPositionId)) traderOpenPositionIds;

    address[] d_tpslAdmins; // deprecated
